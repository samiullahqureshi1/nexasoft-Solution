    ...
    >
      ...
      <div className="relative z-10 max-w-4xl px-6">
        ...
        <h2 className="font-heading text-6xl leading-tight mb-12">
          Have a <span className="text-red-600">project</span> in mind?
          <br />
          Let’s get to work.
        </h2>
        ...
        <div className="flex justify-center">
          <button className="group hover:bg-[#9C0000] relative w-40 h-40 rounded-full border border-black/20 flex flex-col hover:text-white items-center justify-center font-body tracking-widest text-sm transition hover:border-red-600">
